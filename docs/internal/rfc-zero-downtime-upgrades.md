...
[HeliosProxy](https://github.com/HeliosDatabase/HeliosDB-Proxy) (Apache 2.0).
...
- The proxy itself is at v0.3.1, [private repo,
  Apache 2.0](https://github.com/HeliosDatabase/HeliosDB-Proxy).
...
- Repo: <https://github.com/HeliosDatabase/HeliosDB-Proxy>
